  ...
  <div class="bottom-action-bar">
    <div class="action-content">
      <div class="action-buttons" align="right">
        <t-popconfirm content="确定要重置所有已填写的内容吗？" @confirm=handleReset>
          <t-button theme="default" variant="outline" size="large">
            <template #icon><file-restore-icon :fill-color='"transparent"' :stroke-color='"currentColor"'
                :stroke-width="2" /></template>
            重置
          </t-button>
        </t-popconfirm>
        <t-button theme="primary" size="large" :loading="filingStore.submitting" @click="emitSubmit" class="btn-submit">
